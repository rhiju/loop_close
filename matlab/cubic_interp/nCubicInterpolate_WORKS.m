function [val,deriv] = nCubicInterpolate_WORKS( F, x, minval, binwidth, boundary )
...
if ( Ndim == 1 )
    ...
    for i = 1:4
        ...
        [p(i),dp_dy(:,i)] = nCubicInterpolate_WORKS(Fslice_i, x(2:end), minval(2:end), binwidth(2:end), boundary(2:end) );
    end
