function [C] = random(OL,OR,mult)
% random(OL,OR,mult) - constructs crystal orientations for a randomly 
%   textured material with sample symmetry OL, crystal symmetry OR, and a 
%   number of crystals given by mult. Returns crystal orientations as 
%   rotation matrices in the struct C.
% 
% 
