function real_plot(rhsh,bounded,crystal_type,sectioning,plot_type)
% real_plot(rhsh,bounded,crystal_type,sectioning,plot_type) - visualization
%   of the function stored in rhsh by the expansion coefficients over the
%   real harmonics. rhsh is the return value of real_coeffs.m. When
